...
class Api
{
    ...
    public const OPTION_CERTIF_TEST    = 'certif_test';
    public const OPTION_CERTIF_PROD    = 'certif_prod';
    public const OPTION_HASH_ALGORITHM = 'hash_algorithm';
    public const OPTION_ENDPOINT       = 'endpoint';

    public const OPTION_ENDPOINT_PAYZEN       = 'payzen';
    public const OPTION_ENDPOINT_SYSTEMPAY    = 'systempay';
    public const OPTION_ENDPOINT_SOGECOMMERCE = 'sogecommerce';
    ...
    private const ENDPOINT_PAYZEN       = 'https://secure.payzen.eu/vads-payment/';
    private const ENDPOINT_SYSTEMPAY    = 'https://paiement.systempay.fr/vads-payment/';
    private const ENDPOINT_SOGECOMMERCE = 'https://sogecommerce.societegenerale.eu/vads-payment/';
    ...
    {
        return match ($this->getEndpoint()) {
            self::OPTION_ENDPOINT_SYSTEMPAY    => self::ENDPOINT_SYSTEMPAY,
            self::OPTION_ENDPOINT_SOGECOMMERCE => self::ENDPOINT_SOGECOMMERCE,
            default                            => self::ENDPOINT_PAYZEN,
        };
    }

    protected function getEndpoint(): string
    {
        return $this->options[self::OPTION_ENDPOINT] ?? '';
    }

    protected function getContextMode(): string
    {
        return true === $this->options[self::OPTION_SANDBOX]
    ...
    protected function getCertificate(): string
    {
        return self::CONTEXT_MODE_PRODUCTION === $this->getContextMode()
            ? $this->options[self::OPTION_CERTIF_PROD]
            : $this->options[self::OPTION_CERTIF_TEST];
    }

    protected function getHashAlgorithm(): string
    {
        return SignatureAlgorithm::fromPayumOption($this->options[self::OPTION_HASH_ALGORITHM]);
    }
