...
class ApiTest extends TestCase
{
     ...
     */
    public function testConstants(string $constantValue, string $expectedValue): void
    {
        static::assertSame($expectedValue, $constantValue);
    }
    ...
    public function testGetAlgorithmHash(): void
    {
        ...
        $signatureGenerator->method('generate')
            ->with(static::isType('array'), static::equalTo('the test certificate'), static::equalTo('sha1'))
